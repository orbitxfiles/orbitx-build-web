...
export default async function EditThemePage({
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-semibold text-white">Edit theme</h1>
      <form action={updateThemeAction} className="mt-8 space-y-4 rounded-xl border border-white/15 bg-[#18364c]/70 p-6">
